  ...
  const plans = [
    {
      ...
      features: [
        'Suite completa de módulos clínicos habilitada',
        'Control de Calidad esencial (Levey-Jennings y calibradores)',
        'Conexión LIS para 1 analizador automático (HL7/ASTM)',
        'Membrete oficial con logo y datos sanitarios',
        'Convenios y listas de precios locales por sede',
        'Expediente completo de pacientes y resultados oficiales',
        'Catálogo de estudios clínicos y reactivos base',
    ...
    },
    {
      ...
      features: [
        'Capacidad intermedia para laboratorios en expansión',
        'Control de Calidad avanzado (reglas Westgard automáticas)',
        'Conexión LIS multi-analizador (hasta 4 analizadores simultáneos)',
        'Membretes oficiales multisede avanzados y firmas digitales',
        'Convenios empresariales multisede compartidos',
        'Descuento automático de reactivos por corrida analítica',
        'Expediente clínico multisede y reportes acumulativos',
        'Soporte técnico prioritario y asistencia LIS',
      ],
      highlight: true,
    },
    {
      ...
      features: [
        'Capacidad corporativa total sin restricciones de volumen',
        'Órdenes de trabajo ILIMITADAS al mes',
        'Sedes clínicas ILIMITADAS en red hospitalaria',
        'Conexión LIS multi-analizador en paralelo sin límite',
        'Control de calidad multi-nivel y auditorías COFEPRIS',
        'Formatos clínicos y membretes corporativos a medida',
        'Convenios corporativos y aseguradoras ilimitados',
